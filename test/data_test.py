...
from qtsys.yahoo import YahooData
...
def test_tradier_daily_bars():
  daily_bars = TradierData('paper').get_bars('NVDA TSLA', start='2021-05-02', end='2021-08-01', interval='daily')
  print(daily_bars)
  assert daily_bars is not None
...
def test_tradier_hourly_bars():
  hourly_bars = TradierData('live').get_bars('NVDA TSLA', start='2021-10-22', end='2021-11-23')
  print(hourly_bars) 
  assert hourly_bars is not None
